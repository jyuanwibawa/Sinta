            ...
            <div class="card card-navy card-tabs">
                <div class="card-header p-0 pt-1">
                    <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="lampiran-tab" data-toggle="pill" href="#lampiran" role="tab" aria-controls="custom-tabs-four-profile" aria-selected="false">Lampiran Seksi</a>
                        </li>
                        <li class="nav-item">
                                        ...
                                        foreach ($get_kajian as $lkajian) :
                                            ...
                                            <div>
                                                ...
                                                <div class="timeline-item">
                                                    <span class="time"><i class="fas fa-clock"></i> <?= indonesian_date($lkajian->created_at) ?></span>
                                                    <h3 class="timeline-header">Kajian Seksi <a href="#"><?= $lkajian->jkajian ?></a></h3>
                                                    ...
                                                    <div class="timeline-body">
                                                        ...
                                                        <br><?= $lkajian->isi_kajian ?>
                                                        </pre>
                                                    </div>
                                                    <div class="timeline-footer">
                                                        <a href="<?= base_url('kasus/edit_kajian/' . $elsya_enkrip_kajian) ?>">Edit</a>
                                                        <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#ek<?= $elsya_enkrip_kajian ?>">
                                                            Edit
                                                        </button>
                                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hk<?= $elsya_enkrip_kajian ?>">
                                                            Hapus
                                                        </button>
                                                    </div>
                                                </div>
                                        ...
                                        foreach ($get_rekomendasi as $lrekom) :
                                            ...
                                            <div>
                                                ...
                                                <div class="timeline-item">
                                                    ...
                                                    <h3 class="timeline-header">Rekomendasi dari <a href="#"><?= $lrekom->nama ?></a></h3>
